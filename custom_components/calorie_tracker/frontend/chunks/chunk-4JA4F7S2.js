import{a as it,b as d,g as at,h as lt}from"./chunk-EMR7U3YA.js";import{a as f,b,c as et,e as nt,g as _}from"./chunk-5HHMTMB7.js";var mt=nt(()=>{lt();function dt(y){let w=t=>String(t).padStart(2,"0");return`${y.getFullYear()}-${w(y.getMonth()+1)}-${w(y.getDate())}T${w(y.getHours())}:${w(y.getMinutes())}:${w(y.getSeconds())}`}function ct(y){if(!y)return"";let w=new Date(y),t=String(w.getHours()).padStart(2,"0"),e=String(w.getMinutes()).padStart(2,"0");return`${t}:${e}`}function ht(y){let[w,t,e]=y.split("-").map(Number);return new Date(w,t-1,e)}function E(y=new Date){let w=y.getFullYear(),t=String(y.getMonth()+1).padStart(2,"0"),e=String(y.getDate()).padStart(2,"0");return`${w}-${t}-${e}`}function pt(y){let w=y?ht(y):new Date;return`${w.getDate().toString().padStart(2,"0")} ${w.toLocaleString(void 0,{month:"short"})} ${w.getFullYear()}`}var ut=(y=24)=>d`
  <svg width="${y}" height="${y}" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
User request: ${i}`);let A={type:"conversation/process",text:x,conversation_id:this._conversationId,language:c.language||"en"};(o=this._selectedAgent)!=null&&o.id&&(A.agent_id=this._selectedAgent.id);let v=await c.connection.sendMessagePromise(A);v.conversation_id&&(this._conversationId=v.conversation_id);let $="Command processed successfully";if((g=(r=(h=v.response)==null?void 0:h.speech)==null?void 0:r.plain)!=null&&g.speech)$=v.response.speech.plain.speech;else if((p=v.response)!=null&&p.text)$=v.response.text;else if(typeof v.response=="string")$=v.response;else if(v.response&&typeof v.response=="object")if(v.response.profile){let k=v.response.profile,P=k.daily_goal-k.calories_today;$=`Logged successfully for ${k.spoken_name}. You have ${P} calories remaining today.`}else $=JSON.stringify(v.response);this._chatHistory=[...this._chatHistory,{role:"assistant",text:$}],this.dispatchEvent(new CustomEvent("refresh-daily-data",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("refresh-summary",{bubbles:!0,composed:!0}))}catch(c){this._chatHistory=[...this._chatHistory,{role:"assistant",text:`Failed to process command: ${c.message}`}]}});_(this,"_editWeight",async()=>{var n,l,o,h,r,g;let t=(n=this.log)==null?void 0:n.weight,e=(o=(l=this.profile)==null?void 0:l.attributes)==null?void 0:o.current_weight,i=(h=t!=null?t:e)!=null?h:null,a=((g=(r=this.profile)==null?void 0:r.attributes)==null?void 0:g.weight_unit)||"lbs",s=prompt(`Enter weight in ${a} (current: ${i?i+" "+a:"not set"}):`,i||"");if(s!==null&&s.trim()!==""){let p=parseFloat(s.trim());if(!isNaN(p)&&p>0)try{await this.hass.callService("calorie_tracker","log_weight",{spoken_name:this.profile.attributes.spoken_name,weight:p,timestamp:this.selectedDate||new Date().toISOString().split("T")[0]}),this.dispatchEvent(new CustomEvent("refresh-daily-data",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("refresh-summary",{bubbles:!0,composed:!0}))}catch(c){alert(`Error saving weight: ${c.message}`)}else alert("Please enter a valid weight greater than 0.")}});_(this,"_editBodyFat",async()=>{var s,n,l,o;let t=(s=this.log)==null?void 0:s.body_fat_pct,e=(l=(n=this.profile)==null?void 0:n.attributes)==null?void 0:l.body_fat_percentage,i=(o=t!=null?t:e)!=null?o:null,a=prompt(`Enter body fat percentage (current: ${i?i.toFixed(1)+"%":"not set"}):`,i||"");if(a!==null&&a.trim()!==""){let h=parseFloat(a.trim());if(!isNaN(h)&&h>=1&&h<=50)try{await this.hass.callService("calorie_tracker","log_body_fat",{spoken_name:this.profile.attributes.spoken_name,body_fat_pct:h,timestamp:this.selectedDate||new Date().toISOString().split("T")[0]}),this.dispatchEvent(new CustomEvent("refresh-daily-data",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("refresh-summary",{bubbles:!0,composed:!0}))}catch(r){alert(`Error saving body fat: ${r.message}`)}else alert("Please enter a valid body fat percentage between 1 and 50.")}});this._initializeState(),this._showMetrics=window.matchMedia("(min-width: 600px)").matches,this._mediaQuery=window.matchMedia("(min-width: 600px)"),this._userToggledMetrics=!1,this._mediaQueryListener=t=>{this._userToggledMetrics||(this._showMetrics=t.matches,this.requestUpdate())},this._keyboardVisible=!1,this._keyboardHeight=0}_initializeState(){this._editIndex=-1,this._editData=null,this._showEditPopup=!1,this._addEntryType="food",this._addData={},this._addError="",this._showAddPopup=!1,this.imageAnalyzers=[],this._showAnalyzerSelect=!1,this._showPhotoUpload=!1,this._selectedAnalyzer=null,this._photoFile=null,this._photoError="",this._photoLoading=!1,this._photoDetectedItems=null,this._showPhotoReview=!1,this._photoReviewItems=null,this._photoReviewRaw=null,this._photoReviewAnalyzer=null,this._rememberAnalyzerChoice=!1,this._cameraStarting=!1,this._cameraActive=!1,this._cameraError="",this._cameraStream=null,this._useSystemCapture=!1,this._systemCaptureReason=null,this._showChatAssist=!1,this._assistPipelines=[],this._selectedPipeline=null,this._conversationAgents=[],this._selectedAgent=null,this._chatHistory=[],this._chatInput="",this._conversationId=null,this._showMissingLLMModal=!1,this._missingLLMModalType=null,this._editError="",this._showOffSearch=!1,this._offQuery="",this._offResults=[],this._offSearching=!1,this._offError="",this._offSelectedItem=null,this._offPortion=100}connectedCallback(){super.connectedCallback(),this._mediaQuery.addEventListener("change",this._mediaQueryListener),this._showMetrics=this._mediaQuery.matches,this._handleResize=this._handleResize.bind(this),window.addEventListener("resize",this._handleResize),this._setupKeyboardDetection(),this._onOpenPhotoAnalysis=t=>{var e;try{let i=(e=t==null?void 0:t.detail)==null?void 0:e.modal;this._openPhotoAnalysis().then(()=>{i&&setTimeout(()=>{try{i==="food_camera"&&typeof this._selectAnalysisType=="function"?this._selectAnalysisType("food"):i==="bodyfat_camera"&&typeof this._selectAnalysisType=="function"&&this._selectAnalysisType("bodyfat")}catch(a){}},200)}).catch(()=>{})}catch(i){}},this.addEventListener("open-photo-analysis",this._onOpenPhotoAnalysis),this._onOpenChatAssist=t=>{try{typeof this._openChatAssist=="function"&&this._openChatAssist()}catch(e){}},this.addEventListener("open-chat-assist",this._onOpenChatAssist)}disconnectedCallback(){super.disconnectedCallback(),this._mediaQuery.removeEventListener("change",this._mediaQueryListener),window.removeEventListener("resize",this._handleResize),this._modalPositionInterval&&(clearInterval(this._modalPositionInterval),this._modalPositionInterval=null),this._cleanupKeyboardDetection(),this._stopCameraStream(),this.removeEventListener("open-photo-analysis",this._onOpenPhotoAnalysis),this._onOpenChatAssist&&(this.removeEventListener("open-chat-assist",this._onOpenChatAssist),this._onOpenChatAssist=null)}_handleResize(){(this._showEditPopup||this._showAddPopup||this._showAnalyzerSelect||this._showAnalysisTypeSelect||this._showPhotoUpload||this._showPhotoReview||this._showMissingLLMModal||this._showChatAssist)&&this._positionModalsInContentArea()}_positionModalsInContentArea(){var t,e,i,a,s,n,l;try{let o=(t=this.renderRoot)==null?void 0:t.querySelectorAll(".modal");if(!(o!=null&&o.length))return;let h=(i=(e=this.contentBounds)==null?void 0:e.left)!=null?i:0,r=(s=(a=this.contentBounds)==null?void 0:a.width)!=null?s:window.innerWidth,g=(l=(n=this.contentBounds)==null?void 0:n.top)!=null?l:0;o.forEach(p=>{if(p.offsetParent===null)return;p.style.setProperty("background","rgba(0,0,0,0.5)","important"),p.style.setProperty("position","fixed","important"),p.style.setProperty("top","0px","important"),p.style.setProperty("bottom","0px","important"),p.style.setProperty("left","0px","important"),p.style.setProperty("right","0px","important"),p.style.setProperty("z-index","9999","important"),p.style.setProperty("display","flex","important");let c=p.classList.contains("photo-modal");p.style.setProperty("align-items",c?"flex-start":"center","important"),p.style.setProperty("justify-content","center","important"),p.style.setProperty("box-sizing","border-box","important");let m=g>0?g:0;c&&(m+=60),m>0?p.style.setProperty("padding-top",`${m}px`,"important"):p.style.setProperty("padding-top","0px","important");let u=p.querySelector(".modal-content");if(u&&r<window.innerWidth){let v=Math.min(r-32,400),$=h+(r-v)/2;u.style.position="absolute",u.style.left=`${$}px`,u.style.width=`${v}px`,u.style.right="",u.style.marginLeft="0",u.style.marginRight="0",u.style.maxWidth="400px"}else u&&(u.style.position="",u.style.left="",u.style.width="",u.style.right="",u.style.marginLeft="",u.style.marginRight="",u.style.maxWidth="")})}catch(o){console.warn("Failed to position modals:",o)}}_cleanupModalPositioning(){var t;try{let e=(t=this.renderRoot)==null?void 0:t.querySelectorAll(".modal");if(!(e!=null&&e.length))return;e.forEach(i=>{i.style.position="",i.style.left="",i.style.right="",i.style.top="",i.style.bottom="",i.style.alignItems="",i.style.justifyContent="",i.style.paddingTop="",i.style.transform="",i.style.zIndex="",i.style.background="";let a=i.querySelector(".modal-content");a&&(a.style.marginLeft="",a.style.marginRight="",a.style.maxWidth="")})}catch(e){}}_findContentContainer(){let t=this;for(;t;){let e=t.getRootNode&&t.getRootNode();if(e&&e.host){t=e.host;continue}if(t=t.parentNode,!t)break;if(t.querySelector){let i=t.querySelector(".content");if(i)return i}}return document.querySelector(".content")}updated(t){super.updated(t),["_showEditPopup","_showAddPopup","_showAnalyzerSelect","_showAnalysisTypeSelect","_showPhotoUpload","_showPhotoReview","_showMissingLLMModal","_showChatAssist"].some(a=>t.has(a))&&requestAnimationFrame(()=>{this._positionModalsInContentArea()}),t.has("_showPhotoUpload")&&(this._showPhotoUpload&&!this._useSystemCapture?(this._cameraError="",this._startCameraStream()):this._stopCameraStream())}_logToServer(t,e){try{let i=this.hass||(window==null?void 0:window.hass);i!=null&&i.callService?i.callService("system_log","write",{level:t,message:`Calorie Tracker Frontend: ${e}`}):console.warn("Cannot log to server, hass.callService not available.")}catch(i){console.error("Failed to send log to server:",i)}}_sanitizeDecimal(t){if(t==null)return"";let e=String(t).trim();e.includes(",")&&((e.match(/,/g)||[]).length===1?e=e.replace(",","."):e=e.replace(/,/g,"")),e=e.replace(/[^0-9.]/g,"");let i=e.indexOf(".");return i!==-1&&(e=e.slice(0,i+1)+e.slice(i+1).replace(/\./g,"")),/^0\d/.test(e)&&(e=e.replace(/^0+/,"0")),e}_parseDurationToMinutes(t){if(t==null)return;let e=String(t).trim();if(e==="")return;if(/^\d+(?:\.\d+)?$/.test(e)){let a=Number(e);return Number.isNaN(a)?void 0:Math.round(a)}let i=e.split(":").map(a=>a.trim());if(i.length===2||i.length===3){let a=i.map(s=>s===""?0:Number(s));if(a.every(s=>!Number.isNaN(s)&&s>=0)){let s=(a.length===3,a[0]),n=(a.length===3,a[1]),l=a.length===3?a[2]:0;return Math.round(s*60+n+l/60)}}}_isValidNumberStr(t){return t!=null&&t!==""&&!isNaN(Number(t))}_validateMacroCalories(t,e,i,a,s,n,l=!1){var u,x;if(!((x=(u=this.profile)==null?void 0:u.attributes)!=null&&x.track_macros)||!t||isNaN(Number(t)))return!0;let o=Number(t),h=this._isValidNumberStr(e)?Number(e)*4:0,r=this._isValidNumberStr(i)?Number(i)*4:0,g=this._isValidNumberStr(a)?Number(a)*9:0,p=this._isValidNumberStr(s)?Number(s)*7:0,c=h+r+g+p;if(c===0)return!0;let m=Math.max(o*.1,20);if(c>o+m){let A=`Calories from macros (${Math.round(c)}) exceed total calories (${o})`;return l?n&&n(A):n(A),!1}return!0}_closeAllModals(){this._stopCameraStream(),this._showEditPopup=!1,this._showAddPopup=!1,this._showAnalyzerSelect=!1,this._showAnalysisTypeSelect=!1,this._showPhotoUpload=!1,this._showPhotoReview=!1,this._showChatAssist=!1,this._showMissingLLMModal=!1,this._useSystemCapture=!1,this._systemCaptureReason=null,this._showOffSearch=!1}_toggleMetrics(){this._userToggledMetrics=!0,this._showMetrics=!this._showMetrics}_setupKeyboardDetection(){window.visualViewport&&(this._onViewportResize=()=>{let t=window.visualViewport,e=window.innerHeight,i=t.height,a=e-i,s=this._keyboardVisible;this._keyboardVisible=a>150,this._keyboardHeight=this._keyboardVisible?a:0,s!==this._keyboardVisible&&this.requestUpdate()},window.visualViewport.addEventListener("resize",this._onViewportResize),window.visualViewport.addEventListener("scroll",this._onViewportResize))}_cleanupKeyboardDetection(){window.visualViewport&&this._onViewportResize&&(window.visualViewport.removeEventListener("resize",this._onViewportResize),window.visualViewport.removeEventListener("scroll",this._onViewportResize),this._onViewportResize=null)}_isCompactDevice(){return window.innerWidth<=430}render(){var n,l,o,h;let t=(l=(n=this.log)==null?void 0:n.food_entries)!=null?l:[],e=(h=(o=this.log)==null?void 0:o.exercise_entries)!=null?h:[],i=pt(this.selectedDate),a=e.length>0,s=t.length>0;return d`
    ...
    `}_renderMeasurementsSection(){var I,L,T,F,R,N,H,B,V,O,U,j,W,q,Q,Z,Y,K,G,J,X,tt;let t=(L=(I=this.profile)==null?void 0:I.attributes)!=null?L:{},e=t.weight_unit||"lbs",i=(T=this.log)==null?void 0:T.weight,a=t.current_weight,s=(F=i!=null?i:a)!=null?F:null,n=(R=this.log)==null?void 0:R.body_fat_pct,l=t.body_fat_percentage,o=(N=n!=null?n:l)!=null?N:null,h=(H=this.log)==null?void 0:H.bmr_and_neat,r=(V=(B=this.profile)==null?void 0:B.attributes)==null?void 0:V.bmr_and_neat,g=(O=h!=null?h:r)!=null?O:null,p=(j=(U=this.log)==null?void 0:U.macros)!=null?j:null,c=!!((q=(W=this.profile)==null?void 0:W.attributes)!=null&&q.track_macros),m=p?Number((Z=(Q=p.p)!=null?Q:p.protein)!=null?Z:0):0,u=p?Number((K=(Y=p.c)!=null?Y:p.carbs)!=null?K:0):0,x=p?Number((J=(G=p.f)!=null?G:p.fat)!=null?J:0):0,A=p?Number((tt=(X=p.a)!=null?X:p.alcohol)!=null?tt:0):0,v=m*4,$=u*4,k=x*9,P=A*7,S=v+$+k+P,z=S>0?Math.round(v/S*100):0,D=S>0?Math.round($/S*100):0,M=S>0?Math.round(k/S*100):0,ft=S>0?Math.round(P/S*100):0,st=c,ot=d`
    ...
    `;return d`
      ${st?d`
        ...
        <div class="macro-line" style="margin-top:8px; font-size:0.98em; color: var(--secondary-text-color, #666);">
          Protein: ${m}g<span class="protein-percent">${z>0?` (${z}%)`:""}</span>&nbsp;&nbsp;&nbsp;Carbs: ${u}g<span class="carbs-percent">${D>0?` (${D}%)`:""}</span>&nbsp;&nbsp;&nbsp;Fat: <span class="fat-grams">${x}g${M>0?` (${M}%)`:""}</span><span class="fat-percent">${M>0?`${M}%`:"0%"}</span>
        </div>
      `:""}
        ...
        <ul class="item-list measurements-list">
          ...
          ${g?d`
            <li class="item measurement-item calculation-item">
              ...
              <span class="measurement-value">${Math.round(g)} Cal</span>
              <span></span>
            </li>
          `:""}
        </ul>
    ...
    `}_renderEntry(t,e,i){var s,n,l,o;let a=ct(t.timestamp);return i==="exercise"?d`
        <li class="item">
      ...
      `:d`
        <li class="item">
          <span class="item-time">${a}</span>
          <span class="item-name">${(l=t.food_item)!=null?l:"Unknown"}</span>
      ...
      <div class="modal" style="z-index: 2000;" @click=${this._closeOffSearch}>
        <div class="modal-content" style="max-height: 80vh; display: flex; flex-direction: column;" @click=${e=>e.stopPropagation()}>
          ...
          `:d`
            ...
            ${this._offSearching?d`<div style="text-align:center; padding: 20px;">Searching...</div>`:""}
            ${this._offError?d`<div style="color: #f44336; margin-bottom: 12px;">${this._offError}</div>`:""}
            
            <div style="flex-grow: 1; overflow-y: auto; max-height: 400px;">
              ${this._offResults.map(e=>{var i;return d`
                <div 
    ...
    `}_openEdit(t,e){var a,s,n,l,o;let i="";if(e.timestamp){let h=new Date(e.timestamp),r=String(h.getHours()).padStart(2,"0"),g=String(h.getMinutes()).padStart(2,"0");i=`${r}:${g}`}e.type==="exercise"?this._editData=b(f({},e),{exercise_type:(a=e.exercise_type)!=null?a:"",duration_minutes:(s=e.duration_minutes)!=null?s:"",calories_burned:(n=e.calories_burned)!=null?n:0,time:i}):this._editData=f(f(f(f(b(f({},e),{food_item:(l=e.food_item)!=null?l:"",calories:(o=e.calories)!=null?o:0,time:i}),e.p!==void 0?{p:String(e.p)}:{}),e.c!==void 0?{c:String(e.c)}:{}),e.f!==void 0?{f:String(e.f)}:{}),e.a!==void 0?{a:String(e.a)}:{}),this._editIndex=t,this._showEditPopup=!0,this._editError=""}_closeEdit(){this._showEditPopup=!1,this._editIndex=-1,this._editData=null,this._editError=""}_onEditInput(t,e){let i=t.target.value;if(["p","c","f","a"].includes(e)&&(i=this._sanitizeDecimal(i),i!==t.target.value&&(t.target.value=i)),e==="duration_minutes"){let a=String(i).replace(/[^0-9:]/g,"");a!==i&&(t.target.value=a,i=a)}this._editData=b(f({},this._editData),{[e]:i}),this._editError=""}_onEditTimeInput(t){let e=t.target.value;this._editData=b(f({},this._editData),{time:e})}_saveEdit(){if(this._editData.type==="food"&&!this._validateMacroCalories(this._editData.calories,this._editData.p,this._editData.c,this._editData.f,this._editData.a,o=>{this._editError=o}))return;let t=this._editData.timestamp;if(this._editData.time&&this._editData.timestamp){let l=new Date(this._editData.timestamp),[o,h]=this._editData.time.split(":");l.setHours(Number(o)),l.setMinutes(Number(h)),l.setSeconds(0,0),t=dt(l)}let n=this._editData,{time:e,type:i}=n,a=et(n,["time","type"]),s;if(i==="exercise"){let l=this._parseDurationToMinutes(this._editData.duration_minutes);if(this._editData.duration_minutes&&l===void 0){this._editError="Duration must be minutes (e.g. 45) or HH:MM or HH:MM:SS";return}s={entry_id:this._editData.id,entry_type:"exercise",entry:b(f(b(f({},a),{timestamp:t}),l!==void 0?{duration_minutes:Number(l)}:{}),{calories_burned:Number(this._editData.calories_burned)})}}else s={entry_id:this._editData.id,entry_type:"food",entry:f(f(f(f(b(f({},a),{timestamp:t,calories:Number(this._editData.calories)}),this._isValidNumberStr(this._editData.p)?{p:Number(this._editData.p)}:{}),this._isValidNumberStr(this._editData.c)?{c:Number(this._editData.c)}:{}),this._isValidNumberStr(this._editData.f)?{f:Number(this._editData.f)}:{}),this._isValidNumberStr(this._editData.a)?{a:Number(this._editData.a)}:{})};this.dispatchEvent(new CustomEvent("edit-daily-entry",{detail:s,bubbles:!0,composed:!0})),this._closeEdit()}_renderEditPopup(){var e,i,a,s,n,l;let t=this._editData.type==="exercise";return d`
            ...
            `:d`
              ...
              ${(i=(e=this.profile)==null?void 0:e.attributes)!=null&&i.track_macros?d`
                ...
                <input
                  ...
                  inputmode="decimal"
                  pattern="[0-9]*[.]?[0-9]*"
                  .value=${(l=this._editData.a)!=null?l:""}
        ...
        <div class="modal-content photo-modal-content" @click=${u=>u.stopPropagation()}>
          <div class="photo-modal-shell">
            ...
            <div style="font-size:0.98em;margin-bottom:8px;">
              ...
              <div style="font-size:0.9em;opacity:0.8;">Title: ${(p=(g=this._selectedAnalyzer)==null?void 0:g.title)!=null?p:""}; Model: ${(m=(c=this._selectedAnalyzer)==null?void 0:c.model)!=null?m:"Unknown"}</div>
            </div>
            ${i?d`
            ...
            <div class="photo-modal-footer ${l?"overlay":""}">
              <div class=${`photo-modal-actions${l?" compact":""}`}>
                <!--
                  Primary Action:
    ...
    `}_renderFoodItemsReview(){var e,i;let t=!!((i=(e=this.profile)==null?void 0:e.attributes)!=null&&i.track_macros);return d`
      ${this._photoReviewItems.map((a,s)=>{var n,l,o,h;return d`
        <div style="padding:6px 0;border-bottom:1px solid var(--divider-color,#ddd);">
          ...
          ${t?d`
            <div style="display:flex;flex-wrap:wrap;gap:6px;font-size:0.72em;align-items:center;">
              ...
              <label>Fat:
                <span style="position:relative;display:inline-flex;align-items:center;">
                  <input data-edit-field="photo_item_${s}_f" class="edit-input" style="width:46px;padding-right:12px;" type="text" inputmode="decimal" pattern="[0-9]*[.]?[0-9]*" .value=${(l=a.f)!=null?l:""} @input=${r=>this._editPhotoReviewItem(s,"f",r)} />
    ...
    `}_togglePhotoReviewItem(t,e){let i=[...this._photoReviewItems];i[t]=b(f({},i[t]),{selected:e.target.checked}),this._photoReviewItems=i}_editPhotoReviewItem(t,e,i){let a=[...this._photoReviewItems],s=["calories","p","f","c","a","percentage"],n=i.target.value;if(["p","c","f","c","a","percentage"].includes(e)&&e!=="calories"){let l=this._sanitizeDecimal(n);l!==n&&(i.target.value=l),a[t]=b(f({},a[t]),{[e]:l})}else s.includes(e)?a[t]=b(f({},a[t]),{[e]:n===""?void 0:Number(n)}):a[t]=b(f({},a[t]),{[e]:n});this._photoReviewItems=a}_confirmPhotoReview(){var e;if(!this._photoReviewItems||this._photoReviewItems.length===0){this._closePhotoReview();return}if(((e=this._photoReviewItems[0])==null?void 0:e.measurement_type)==="body_fat"){let i=this._photoReviewItems[0];if(!i.percentage||i.percentage<3||i.percentage>50){alert("Please enter a valid body fat percentage (3-50%)");return}let a=this.selectedDate;a||(a=E());let s=new Date,n=String(s.getHours()).padStart(2,"0"),l=String(s.getMinutes()).padStart(2,"0"),o=`${a}T${n}:${l}:00`;this.dispatchEvent(new CustomEvent("add-daily-entry",{detail:{entry_type:"body_fat",entry:{body_fat_percentage:Number(i.percentage),timestamp:o}},bubbles:!0,composed:!0}))}else{let i=this._photoReviewItems.filter(r=>r.selected&&r.food_item&&r.calories!==void 0);if(i.length===0){this._closePhotoReview();return}let a=[];for(let r of i){let g=[];this._validateMacroCalories(r.calories,r.p,r.c,r.f,r.a,c=>g.push(c),!0)||a.push({item:r,warn:g[0]})}if(a.length>0){alert(`One or more food items have calories from macros exceeding total calories. First issue: ${a[0].warn}`);return}let s=this.selectedDate;s||(s=E());let n=new Date,l=String(n.getHours()).padStart(2,"0"),o=String(n.getMinutes()).padStart(2,"0"),h=`${s}T${l}:${o}:00`;i.forEach((r,g)=>{this.dispatchEvent(new CustomEvent("add-daily-entry",{detail:{entry_type:"food",entry:f(f(f(f({food_item:r.food_item,calories:Number(r.calories),timestamp:h,analyzer:this._photoReviewAnalyzer,raw_result:this._photoReviewRaw},this._isValidNumberStr(r.p)?{p:Number(r.p)}:{}),this._isValidNumberStr(r.f)?{f:Number(r.f)}:{}),this._isValidNumberStr(r.c)?{c:Number(r.c)}:{}),this._isValidNumberStr(r.a)?{a:Number(r.a)}:{})},bubbles:!0,composed:!0}))})}this._closePhotoReview()}_renderPhotoProcessingModal(){return this._photoLoading?d`
    ...
    `}_renderChatAssistModal(){var g,p;if(!this._showChatAssist)return"";let t=!1;if(this.hass&&this.hass.themes&&this.hass.selectedTheme){let c=this.hass.selectedTheme;t=((g=c==null?void 0:c.theme)==null?void 0:g.toLowerCase().includes("dark"))||(c==null?void 0:c.dark)===!0}else window.matchMedia&&(t=window.matchMedia("(prefers-color-scheme: dark)").matches);let e="var(--card-background-color)",i="var(--primary-text-color)",a="var(--divider-color)",s=t?"var(--ha-card-background, #23272e)":"var(--ha-card-background, #fafbfc)",n=this._isCompactDevice(),l=this._keyboardVisible,o=this._keyboardHeight||0,h="min(600px, 80vh)",r="400px";if(n&&l){let x=(((p=window.visualViewport)==null?void 0:p.height)||window.innerHeight)-60-40;h=`${Math.max(250,x)}px`,r="250px"}return d`
        ...
        >
          <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px;">
            ...
            <select class="edit-input" style="flex:1;min-width:0;background:${e};color:${i};border:1px solid ${a};" @change=${this._onAgentChange}>
              ${this._conversationAgents.length>0?this._conversationAgents.map(c=>{var m;return d`
          ...
          <div style="flex:1;overflow-y:auto;margin-bottom:12px;border:1px solid ${a};padding:8px 6px 8px 6px;background:${s};">
            ${this._chatHistory.length===0?d`<div style="color:${t?"#aaa":"#888"};text-align:center;">No conversation yet.</div>`:this._chatHistory.map(c=>d`
                  <div style="margin-bottom:8px;">
...
//# sourceMappingURL=chunk-4JA4F7S2.js.map
