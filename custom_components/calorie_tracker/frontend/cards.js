import{a as W,e as B,f as V}from"./chunks/chunk-5HHMTMB7.js";var Se=B(()=>{var ce=class extends HTMLElement{constructor(){super(),this._eventsAttached=!1,this._summaryLoaded=!1,this._styleObserver=null}async _ensureSummaryLoaded(){if(!this._summaryLoaded&&!customElements.get("calorie-summary"))try{await import("./chunks/summary-HU7KEXHE.js"),this._summaryLoaded=!0}catch(e){console.error("Failed to load summary component:",e)}}setConfig(e){this.config=e,this.profileEntityId=e.profile_entity_id||null,this.title=typeof e.title=="string"?e.title:"",this.innerHTML=`
    ...
    `;let e=this.querySelector("paper-input"),t=this.querySelector("ha-entity-picker"),s=this.querySelector(".error"),n=()=>{let a=W({},this._config);e&&e.value?a.title=e.value.trim():delete a.title,t&&t.value?a.profile_entity_id=t.value:delete a.profile_entity_id,a.profile_entity_id?s&&(s.style.display="none"):s&&(s.style.display="block"),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:a}}))};e&&e.addEventListener("value-changed",n),t&&t.addEventListener("value-changed",n)}_escape(e){return String(e).replace(/"/g,"&quot;")}};customElements.get("calorie-summary-editor")||customElements.define("calorie-summary-editor",me);ce.getConfigForm=function(){return{schema:[{name:"title",selector:{text:{}}},{name:"profile_entity_id",required:!0,selector:{entity:{domain:"sensor",allow_custom_entity:!0}}}]}};ce.getStubConfig=function(){return{profile_entity_id:""}}});var Ee=B(()=>{var de=class extends HTMLElement{constructor(){super(),this._eventsAttached=!1,this._dailyDataLoaded=!1}async _ensureDailyDataLoaded(){if(!this._dailyDataLoaded&&!customElements.get("daily-data-card"))try{await import("./chunks/daily-data-HPY3U54N.js"),this._dailyDataLoaded=!0}catch(e){console.error("Failed to load daily-data component:",e)}}setConfig(e){this.config=e,this.profileEntityId=e.profile_entity_id||null,this.title=typeof e.title=="string"?e.title:"",this.innerHTML=`
      <ha-card>
        ${this.title&&this.title.trim()?`<div class="card-header">${this.title}</div>`:""}
        <daily-data-card></daily-data-card>
      </ha-card>
    `}set hass(e){this._hass=e,this._updateCard()}get hass(){return this._hass}_getLocalDateString(e=new Date){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0");return`${t}-${s}-${n}`}async _updateCard(){var n,a,i,r;await this._ensureDailyDataLoaded(),await customElements.whenDefined("daily-data-card");let e=this.querySelector("daily-data-card");if(!e||!this.hass)return;let t=this.profileEntityId;if(t||(t=Object.keys(this.hass.states).find(l=>l.startsWith("sensor.calorie_tracker_")&&l.includes("_profile")&&this.hass.states[l])),!t){console.warn("No calorie tracker profile entity found");return}if(!this.hass.states[t]){console.error(`Entity not found: ${t}`);return}let s=this.hass.states[t];e.hass=this.hass,e.profile=s,e.selectedDate=this.selectedDate||this._getLocalDateString();try{let l=await this.hass.connection.sendMessagePromise({type:"calorie_tracker/get_daily_data",entity_id:t,date:e.selectedDate});e.log={food_entries:(l==null?void 0:l.food_entries)||[],exercise_entries:(l==null?void 0:l.exercise_entries)||[],weight:(n=l==null?void 0:l.weight)!=null?n:null,body_fat_pct:(a=l==null?void 0:l.body_fat_pct)!=null?a:null,bmr_and_neat:(i=l==null?void 0:l.bmr_and_neat)!=null?i:null,macros:(l==null?void 0:l.macros)||null,config_entry_id:(r=l==null?void 0:l.config_entry_id)!=null?r:null}}catch(l){console.error("Failed to fetch daily data:",l),e.log={food_entries:[],exercise_entries:[],weight:null,body_fat_pct:null,bmr_and_neat:null}}this._eventsAttached||(e.addEventListener("select-daily-date",l=>{this.selectedDate=l.detail.date,this._updateCard()}),window.addEventListener("select-summary-date",l=>{this.selectedDate=l.detail.date,this._updateCard()}),e.addEventListener("refresh-daily-data",()=>{this._updateCard()}),e.addEventListener("add-daily-entry",async l=>{try{await this.hass.connection.sendMessagePromise(W({type:"calorie_tracker/add_entry",entity_id:t},l.detail)),this._updateCard()}catch(d){console.error("Failed to add entry:",d)}}),e.addEventListener("edit-daily-entry",async l=>{try{await this.hass.connection.sendMessagePromise(W({type:"calorie_tracker/update_entry",entity_id:t},l.detail)),this._updateCard()}catch(d){console.error("Failed to edit entry:",d)}}),e.addEventListener("delete-daily-entry",async l=>{try{await this.hass.connection.sendMessagePromise(W({type:"calorie_tracker/delete_entry",entity_id:t},l.detail)),this._updateCard()}catch(d){console.error("Failed to delete entry:",d)}}),this._eventsAttached=!0)}};customElements.get("calorie-daily-log-card")||customElements.define("calorie-daily-log-card",de);window.customCards=window.customCards||[];window.customCards.push({type:"calorie-daily-log-card",name:"Calorie Tracker: Daily Log",description:"Daily food/exercise log UI for the Calorie Tracker integration",editor:"calorie-daily-log-editor",preview:!0});var _e=class extends HTMLElement{setConfig(e){this._config=e||{},this._render()}set hass(e){this._hass=e,this._render()}_render(){this._config||(this._config={}),this.innerHTML=`
      <div style="display:flex;flex-direction:column;gap:8px;">
        <paper-input label="Title (optional)" value="${this._escape(this._config.title||"")}"></paper-input>
        <label style="font-size:12px;color:var(--secondary-text-color);">Profile entity (required)</label>
        <ha-entity-picker dialog-opp="right" include-domains="sensor" allow-custom-entity value="${this._escape(this._config.profile_entity_id||"")}"></ha-entity-picker>
    ...
    `}set hass(e){this._hass=e,this._updateCard()}get hass(){return this._hass}_getLocalDateString(e=new Date){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0");return`${t}-${s}-${n}`}async _updateCard(){var n,a,i;let e=this.querySelector(".protein-gauge");if(!e||!this.hass)return;let t=this.profileEntityId;if(t||(t=Object.keys(this.hass.states).find(r=>r.startsWith("sensor.calorie_tracker_")&&this.hass.states[r])),!t){console.warn("No calorie tracker profile entity found");return}if(!this.hass.states[t]){console.error(`Entity not found: ${t}`);return}let s=this.hass.states[t];this._profile=s,this._selectedDate=this.selectedDate||this._getLocalDateString(),this._applyProteinStyles(e);try{let r=await this.hass.connection.sendMessagePromise({type:"calorie_tracker/get_daily_data",entity_id:t,date:this._selectedDate}),l=(n=r==null?void 0:r.weight)!=null?n:null,d=(a=r==null?void 0:r.weight_unit)!=null?a:null,u=(i=r==null?void 0:r.macros)!=null?i:{},c=Math.round(u.p||u.protein||0),F=this._profile&&this._profile.attributes||{},H=Number(F.current_weight),$=F.weight_unit||d||"lbs",b=(m,g,w)=>Number.isFinite(m)?!g||!w||g===w?m:g==="kg"&&w==="lbs"?m*2.20462:g==="lbs"&&w==="kg"?m/2.20462:m:null,y=Number.isFinite(H)?H:null;!Number.isFinite(y)&&Number.isFinite(l)&&(y=b(Number(l),d||$,$));let M=Number.isFinite(y)?y:null,k=Number.isFinite(y)?$==="kg"?y*2.20462:y:null,_=m=>m==null?null:m<5&&M!==null?Math.round(m*M):m,p=_(this.min),L=_(this.max),A=k!=null?k:150,C=Math.ceil(A/10)*10;(!Number.isFinite(C)||C<=0)&&(C=150),L!==null&&(C=L),this._gaugeMax=C,this._gaugeMin=p!==null?p:0,this._proteinValue=c,this._proteinWeight=k||0,this._proteinMin=p,this._proteinMax=L,this._renderGauge()}catch(r){console.error("Failed to fetch protein data:",r)}this._eventsAttached||(window.addEventListener("select-summary-date",r=>{this.selectedDate=r.detail.date,this._updateCard()}),window.addEventListener("select-daily-date",r=>{this.selectedDate=r.detail.date,this._updateCard()}),window.addEventListener("refresh-summary",()=>{this._updateCard()}),this._eventsAttached=!0)}_applyProteinStyles(e){if(!e)return;let t=e.querySelector(".protein-svg");t&&(t.style.width="100%",t.style.height="auto",t.style.maxWidth=this.maxHeight,t.style.maxHeight=this.maxHeight)}};customElements.get("protein-gauge-card")||customElements.define("protein-gauge-card",ie);window.customCards=window.customCards||[];window.customCards.push({type:"protein-gauge-card",name:"Calorie Tracker: Protein Gauge",description:"Displays a protein gauge for the Calorie Tracker integration",editor:"protein-gauge-editor",preview:!0});var be=class extends HTMLElement{setConfig(e){this._config=e||{},this._render()}set hass(e){this._hass=e,this._render()}_render(){var d,u;this._config||(this._config={}),this.innerHTML=`
      <div style="display:flex;flex-direction:column;gap:8px;">
        <paper-input label="Title (optional)" value="${this._escape(this._config.title||"")}"></paper-input>
        <label style="font-size:12px;color:var(--secondary-text-color);">Profile entity (required)</label>
        <ha-entity-picker dialog-opp="right" include-domains="sensor" allow-custom-entity value="${this._escape(this._config.profile_entity_id||"")}"></ha-entity-picker>
        <paper-input label="Max height (e.g. 400px)" value="${this._escape(this._config.max_height||"400px")}"></paper-input>
        <paper-input label="Min (optional, grams or fraction)" value="${this._escape((d=this._config.min)!=null?d:"")}"></paper-input>
        <paper-input label="Max (optional, grams or fraction)" value="${this._escape((u=this._config.max)!=null?u:"")}"></paper-input>
        <div class="error" style="color:var(--error-color);display:none;">Profile entity is required</div>
      </div>
    `;let e=this.querySelectorAll("paper-input"),t=e[0],s=e[1],n=e[2],a=e[3],i=this.querySelector("ha-entity-picker"),r=this.querySelector(".error"),l=()=>{let c=W({},this._config);t&&t.value?c.title=t.value.trim():delete c.title,i&&i.value?c.profile_entity_id=i.value:delete c.profile_entity_id,s&&s.value?c.max_height=s.value.trim():delete c.max_height,n&&n.value?c.min=Number(n.value):delete c.min,a&&a.value?c.max=Number(a.value):delete c.max,c.profile_entity_id?r&&(r.style.display="none"):r&&(r.style.display="block"),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:c}}))};e.forEach(c=>c.addEventListener("value-changed",l)),i&&i.addEventListener("value-changed",l)}_escape(e){return String(e).replace(/"/g,"&quot;")}};customElements.get("protein-gauge-editor")||customElements.define("protein-gauge-editor",be);ie.getConfigForm=function(){return{schema:[{name:"title",selector:{text:{}}},{name:"profile_entity_id",required:!0,selector:{entity:{domain:"sensor",allow_custom_entity:!0}}},{name:"max_height",selector:{text:{}}},{name:"min",selector:{number:{}}},{name:"max",selector:{number:{}}}]}};ie.getStubConfig=function(){return{profile_entity_id:"",max_height:"400px"}};ie.prototype._renderGauge=function(){let D=this.querySelector(".protein-svg");if(!D)return;let e=Math.max(0,this._proteinValue||0),t=this._proteinMin,s=this._proteinMax,n=this._gaugeMax||100,a=s!==null?s*1.1:n*1.1,i={x:70,y:70},r=40,l=8,d=-180,u=0,c=u-d,F=Math.max(Math.min(e/a,1),0),H=d+F*c,$=o=>o*Math.PI/180,b=(o,f,x)=>{let v=$(o),I=$(f),P=i.x+x*Math.cos(v),q=i.y+x*Math.sin(v),O=i.x+x*Math.cos(I),G=i.y+x*Math.sin(I),z=Math.abs(f-o)>180?1:0;return`M ${P} ${q} A ${x} ${x} 0 ${z} 1 ${O} ${G}`},y=8,M=[5,10,25,50,100,200],k=M[0];for(let o of M)if(a/o<=y){k=o;break}let _=[];for(let o=0;o<=a;o+=k){let f=o/a,x=d+f*c,v=$(x),I=r+5,P=r+12,q=r+20,O=i.x+I*Math.cos(v),G=i.y+I*Math.sin(v),z=i.x+P*Math.cos(v),Y=i.y+P*Math.sin(v),X=i.x+q*Math.cos(v),R=i.y+q*Math.sin(v);_.push({line:`M ${O} ${G} L ${z} ${Y}`,label:{x:X,y:R,value:o}})}let p=[];if(t===null&&s===null)p.push({startAngle:d,endAngle:u,color:"#4caf50"});else if(t!==null&&s===null){let o=t/a,f=d+o*c;p.push({startAngle:d,endAngle:f,color:"#ffeb3b"}),p.push({startAngle:f,endAngle:u,color:"#4caf50"})}else if(t===null&&s!==null){let o=s/a,f=d+o*c;p.push({startAngle:d,endAngle:f,color:"#4caf50"}),p.push({startAngle:f,endAngle:u,color:"#f44336"})}else{let o=t/a,f=s/a,x=d+o*c,v=d+f*c;p.push({startAngle:d,endAngle:x,color:"#ffeb3b"}),p.push({startAngle:x,endAngle:v,color:"#4caf50"}),p.push({startAngle:v,endAngle:u,color:"#f44336"})}let L=$(H),A=r-5,C=i.x+A*Math.cos(L),m=i.y+A*Math.sin(L),g="#4caf50";t!==null&&s!==null?e<t?g="#ffeb3b":e>=t&&e<=s?g="#4caf50":g="#f44336":t!==null&&s===null?e<t?g="#ffeb3b":g="#4caf50":t===null&&s!==null&&(e<=s?g="#4caf50":g="#f44336");let w=`
  ...
  `,D.innerHTML=w}});var Te=B(()=>{var se=class extends HTMLElement{constructor(){super(),this._eventsAttached=!1,this.maxHeight="400px"}setConfig(e){this.config=e||{},this.profileEntityId=e.profile_entity_id||null,this.title=typeof e.title=="string"?e.title:"",this.maxHeight=e.max_height||"400px",this.min=typeof e.min=="number"?e.min:null,this.max=typeof e.max=="number"?e.max:null,this.innerHTML=`
    ...
    `}set hass(e){this._hass=e,this._updateCard()}get hass(){return this._hass}_getLocalDateString(e=new Date){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0");return`${t}-${s}-${n}`}async _updateCard(){var n,a,i;let e=this.querySelector(".fat-gauge");if(!e||!this.hass)return;let t=this.profileEntityId;if(t||(t=Object.keys(this.hass.states).find(r=>r.startsWith("sensor.calorie_tracker_")&&this.hass.states[r])),!t){console.warn("No calorie tracker profile entity found");return}if(!this.hass.states[t]){console.error(`Entity not found: ${t}`);return}let s=this.hass.states[t];this._profile=s,this._selectedDate=this.selectedDate||this._getLocalDateString(),this._applyFatStyles(e);try{let r=await this.hass.connection.sendMessagePromise({type:"calorie_tracker/get_daily_data",entity_id:t,date:this._selectedDate}),l=(n=r==null?void 0:r.weight)!=null?n:null,d=(a=r==null?void 0:r.weight_unit)!=null?a:null,u=(i=r==null?void 0:r.macros)!=null?i:{},c=Math.round(u.f||u.fat||0),F=this._profile&&this._profile.attributes||{},H=Number(F.current_weight),$=F.weight_unit||d||"lbs",b=(m,g,w)=>Number.isFinite(m)?!g||!w||g===w?m:g==="kg"&&w==="lbs"?m*2.20462:g==="lbs"&&w==="kg"?m/2.20462:m:null,y=Number.isFinite(H)?H:null;!Number.isFinite(y)&&Number.isFinite(l)&&(y=b(Number(l),d||$,$));let M=Number.isFinite(y)?y:null,k=Number.isFinite(y)?$==="kg"?y*2.20462:y:null,_=m=>m==null?null:m<5&&M!==null?Math.round(m*M):m,p=_(this.min),L=_(this.max),A=k!=null?k:150,C=Math.ceil(A*.36/10)*10;(!Number.isFinite(C)||C<=0)&&(C=80),L!==null&&(C=L),this._gaugeMax=C,this._gaugeMin=p!==null?p:0,this._fatValue=c,this._fatWeight=k||0,this._fatMin=p,this._fatMax=L,this._renderGauge()}catch(r){console.error("Failed to fetch fat data:",r)}this._eventsAttached||(window.addEventListener("select-summary-date",r=>{this.selectedDate=r.detail.date,this._updateCard()}),window.addEventListener("select-daily-date",r=>{this.selectedDate=r.detail.date,this._updateCard()}),window.addEventListener("refresh-summary",()=>{this._updateCard()}),this._eventsAttached=!0)}_applyFatStyles(e){if(!e)return;let t=e.querySelector(".fat-svg");t&&(t.style.width="100%",t.style.height="auto",t.style.maxWidth=this.maxHeight,t.style.maxHeight=this.maxHeight)}};customElements.get("fat-gauge-card")||customElements.define("fat-gauge-card",se);window.customCards=window.customCards||[];window.customCards.push({type:"fat-gauge-card",name:"Calorie Tracker: Fat Gauge",description:"Displays a fat gauge for the Calorie Tracker integration",editor:"fat-gauge-editor",preview:!0});var we=class extends HTMLElement{setConfig(e){this._config=e||{},this._render()}set hass(e){this._hass=e,this._render()}_render(){var d,u;this._config||(this._config={}),this.innerHTML=`
      <div style="display:flex;flex-direction:column;gap:8px;">
        <paper-input label="Title (optional)" value="${this._escape(this._config.title||"")}"></paper-input>
        <label style="font-size:12px;color:var(--secondary-text-color);">Profile entity (required)</label>
        <ha-entity-picker dialog-opp="right" include-domains="sensor" allow-custom-entity value="${this._escape(this._config.profile_entity_id||"")}"></ha-entity-picker>
    ...
    `;let e=this.querySelectorAll("paper-input"),t=e[0],s=e[1],n=e[2],a=e[3],i=this.querySelector("ha-entity-picker"),r=this.querySelector(".error"),l=()=>{let c=W({},this._config);t&&t.value?c.title=t.value.trim():delete c.title,i&&i.value?c.profile_entity_id=i.value:delete c.profile_entity_id,s&&s.value?c.max_height=s.value.trim():delete c.max_height,n&&n.value?c.min=Number(n.value):delete c.min,a&&a.value?c.max=Number(a.value):delete c.max,c.profile_entity_id?r&&(r.style.display="none"):r&&(r.style.display="block"),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:c}}))};e.forEach(c=>c.addEventListener("value-changed",l)),i&&i.addEventListener("value-changed",l)}_escape(e){return String(e).replace(/"/g,"&quot;")}};customElements.get("fat-gauge-editor")||customElements.define("fat-gauge-editor",we);se.getConfigForm=function(){return{schema:[{name:"title",selector:{text:{}}},{name:"profile_entity_id",required:!0,selector:{entity:{domain:"sensor",allow_custom_entity:!0}}},{name:"max_height",selector:{text:{}}},{name:"min",selector:{number:{}}},{name:"max",selector:{number:{}}}]}};se.getStubConfig=function(){return{profile_entity_id:"",max_height:"400px"}};se.prototype._renderGauge=function(){let D=this.querySelector(".fat-svg");if(!D)return;let e=Math.max(0,this._fatValue||0),t=this._fatMin,s=this._fatMax,n=this._gaugeMax||100,a=s!==null?s*1.1:n*1.1,i={x:70,y:70},r=40,l=8,d=-180,u=0,c=u-d,F=Math.max(Math.min(e/a,1),0),H=d+F*c,$=o=>o*Math.PI/180,b=(o,f,x)=>{let v=$(o),I=$(f),P=i.x+x*Math.cos(v),q=i.y+x*Math.sin(v),O=i.x+x*Math.cos(I),G=i.y+x*Math.sin(I),z=Math.abs(f-o)>180?1:0;return`M ${P} ${q} A ${x} ${x} 0 ${z} 1 ${O} ${G}`},y=8,M=[5,10,25,50,100,200],k=M[0];for(let o of M)if(a/o<=y){k=o;break}let _=[];for(let o=0;o<=a;o+=k){let f=o/a,x=d+f*c,v=$(x),I=r+5,P=r+12,q=r+20,O=i.x+I*Math.cos(v),G=i.y+I*Math.sin(v),z=i.x+P*Math.cos(v),Y=i.y+P*Math.sin(v),X=i.x+q*Math.cos(v),R=i.y+q*Math.sin(v);_.push({line:`M ${O} ${G} L ${z} ${Y}`,label:{x:X,y:R,value:o}})}let p=[];if(t===null&&s===null)p.push({startAngle:d,endAngle:u,color:"#4caf50"});else if(t!==null&&s===null){let o=t/a,f=d+o*c;p.push({startAngle:d,endAngle:f,color:"#ffeb3b"}),p.push({startAngle:f,endAngle:u,color:"#4caf50"})}else if(t===null&&s!==null){let o=s/a,f=d+o*c;p.push({startAngle:d,endAngle:f,color:"#4caf50"}),p.push({startAngle:f,endAngle:u,color:"#f44336"})}else{let o=t/a,f=s/a,x=d+o*c,v=d+f*c;p.push({startAngle:d,endAngle:x,color:"#ffeb3b"}),p.push({startAngle:x,endAngle:v,color:"#4caf50"}),p.push({startAngle:v,endAngle:u,color:"#f44336"})}let L=$(H),A=r-5,C=i.x+A*Math.cos(L),m=i.y+A*Math.sin(L),g="#4caf50";t!==null&&s!==null?e<t?g="#ffeb3b":e>=t&&e<=s?g="#4caf50":g="#f44336":t!==null&&s===null?e<t?g="#ffeb3b":g="#4caf50":t===null&&s!==null&&(e<=s?g="#4caf50":g="#f44336");let w=`
    <svg viewBox="0 0 140 140" style="width: 100%; height: 100%;">
      <!-- Background arc -->
      <path
        d="${b(d,u,r)}"
  ...
  `,D.innerHTML=w}});var qe=B(()=>{var ae=class extends HTMLElement{constructor(){super(),this._eventsAttached=!1,this.maxHeight="400px"}setConfig(e){this.config=e||{},this.profileEntityId=e.profile_entity_id||null,this.title=typeof e.title=="string"?e.title:"",this.maxHeight=e.max_height||"400px",this.min=typeof e.min=="number"?e.min:null,this.max=typeof e.max=="number"?e.max:null,this.innerHTML=`
    ...
    `}set hass(e){this._hass=e,this._updateCard()}get hass(){return this._hass}_getLocalDateString(e=new Date){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0");return`${t}-${s}-${n}`}async _updateCard(){var n,a,i;let e=this.querySelector(".carbs-gauge");if(!e||!this.hass)return;let t=this.profileEntityId;if(t||(t=Object.keys(this.hass.states).find(r=>r.startsWith("sensor.calorie_tracker_")&&this.hass.states[r])),!t){console.warn("No calorie tracker profile entity found");return}if(!this.hass.states[t]){console.error(`Entity not found: ${t}`);return}let s=this.hass.states[t];this._profile=s,this._selectedDate=this.selectedDate||this._getLocalDateString(),this._applyCarbsStyles(e);try{let r=await this.hass.connection.sendMessagePromise({type:"calorie_tracker/get_daily_data",entity_id:t,date:this._selectedDate}),l=(n=r==null?void 0:r.weight)!=null?n:null,d=(a=r==null?void 0:r.weight_unit)!=null?a:null,u=(i=r==null?void 0:r.macros)!=null?i:{},c=Math.round(u.c||u.carbs||0),F=this._profile&&this._profile.attributes||{},H=Number(F.current_weight),$=F.weight_unit||d||"lbs",b=(m,g,w)=>Number.isFinite(m)?!g||!w||g===w?m:g==="kg"&&w==="lbs"?m*2.20462:g==="lbs"&&w==="kg"?m/2.20462:m:null,y=Number.isFinite(H)?H:null;!Number.isFinite(y)&&Number.isFinite(l)&&(y=b(Number(l),d||$,$));let M=Number.isFinite(y)?y:null,k=Number.isFinite(y)?$==="kg"?y*2.20462:y:null,_=m=>m==null?null:m<5&&M!==null?Math.round(m*M):m,p=_(this.min),L=_(this.max),A=k!=null?k:150,C=Math.ceil(A*1.36/10)*10;(!Number.isFinite(C)||C<=0)&&(C=200),L!==null&&(C=L),this._gaugeMax=C,this._gaugeMin=p!==null?p:0,this._carbsValue=c,this._carbsWeight=k||0,this._carbsMin=p,this._carbsMax=L,this._renderGauge()}catch(r){console.error("Failed to fetch carbs data:",r)}this._eventsAttached||(window.addEventListener("select-summary-date",r=>{this.selectedDate=r.detail.date,this._updateCard()}),window.addEventListener("select-daily-date",r=>{this.selectedDate=r.detail.date,this._updateCard()}),window.addEventListener("refresh-summary",()=>{this._updateCard()}),this._eventsAttached=!0)}_applyCarbsStyles(e){if(!e)return;let t=e.querySelector(".carbs-svg");t&&(t.style.width="100%",t.style.height="auto",t.style.maxWidth=this.maxHeight,t.style.maxHeight=this.maxHeight)}};customElements.get("carbs-gauge-card")||customElements.define("carbs-gauge-card",ae);window.customCards=window.customCards||[];window.customCards.push({type:"carbs-gauge-card",name:"Calorie Tracker: Carbs Gauge",description:"Displays a carbs gauge for the Calorie Tracker integration",editor:"carbs-gauge-editor",preview:!0});var $e=class extends HTMLElement{setConfig(e){this._config=e||{},this._render()}set hass(e){this._hass=e,this._render()}_render(){var d,u;this._config||(this._config={}),this.innerHTML=`
      <div style="display:flex;flex-direction:column;gap:8px;">
        <paper-input label="Title (optional)" value="${this._escape(this._config.title||"")}"></paper-input>
        <label style="font-size:12px;color:var(--secondary-text-color);">Profile entity (required)</label>
        <ha-entity-picker dialog-opp="right" include-domains="sensor" allow-custom-entity value="${this._escape(this._config.profile_entity_id||"")}"></ha-entity-picker>
    ...
    `;let e=this.querySelectorAll("paper-input"),t=e[0],s=e[1],n=e[2],a=e[3],i=this.querySelector("ha-entity-picker"),r=this.querySelector(".error"),l=()=>{let c=W({},this._config);t&&t.value?c.title=t.value.trim():delete c.title,i&&i.value?c.profile_entity_id=i.value:delete c.profile_entity_id,s&&s.value?c.max_height=s.value.trim():delete c.max_height,n&&n.value?c.min=Number(n.value):delete c.min,a&&a.value?c.max=Number(a.value):delete c.max,c.profile_entity_id?r&&(r.style.display="none"):r&&(r.style.display="block"),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:c}}))};e.forEach(c=>c.addEventListener("value-changed",l)),i&&i.addEventListener("value-changed",l)}_escape(e){return String(e).replace(/"/g,"&quot;")}};customElements.get("carbs-gauge-editor")||customElements.define("carbs-gauge-editor",$e);ae.getConfigForm=function(){return{schema:[{name:"title",selector:{text:{}}},{name:"profile_entity_id",required:!0,selector:{entity:{domain:"sensor",allow_custom_entity:!0}}},{name:"max_height",selector:{text:{}}},{name:"min",selector:{number:{}}},{name:"max",selector:{number:{}}}]}};ae.getStubConfig=function(){return{profile_entity_id:"",max_height:"400px"}};ae.prototype._renderGauge=function(){let D=this.querySelector(".carbs-svg");if(!D)return;let e=Math.max(0,this._carbsValue||0),t=this._carbsMin,s=this._carbsMax,n=this._gaugeMax||100,a=s!==null?s*1.1:n*1.1,i={x:70,y:70},r=40,l=8,d=-180,u=0,c=u-d,F=Math.max(Math.min(e/a,1),0),H=d+F*c,$=o=>o*Math.PI/180,b=(o,f,x)=>{let v=$(o),I=$(f),P=i.x+x*Math.cos(v),q=i.y+x*Math.sin(v),O=i.x+x*Math.cos(I),G=i.y+x*Math.sin(I),z=Math.abs(f-o)>180?1:0;return`M ${P} ${q} A ${x} ${x} 0 ${z} 1 ${O} ${G}`},y=8,M=[5,10,25,50,100,200],k=M[0];for(let o of M)if(a/o<=y){k=o;break}let _=[];for(let o=0;o<=a;o+=k){let f=o/a,x=d+f*c,v=$(x),I=r+5,P=r+12,q=r+20,O=i.x+I*Math.cos(v),G=i.y+I*Math.sin(v),z=i.x+P*Math.cos(v),Y=i.y+P*Math.sin(v),X=i.x+q*Math.cos(v),R=i.y+q*Math.sin(v);_.push({line:`M ${O} ${G} L ${z} ${Y}`,label:{x:X,y:R,value:o}})}let p=[];if(t===null&&s===null)p.push({startAngle:d,endAngle:u,color:"#4caf50"});else if(t!==null&&s===null){let o=t/a,f=d+o*c;p.push({startAngle:d,endAngle:f,color:"#ffeb3b"}),p.push({startAngle:f,endAngle:u,color:"#4caf50"})}else if(t===null&&s!==null){let o=s/a,f=d+o*c;p.push({startAngle:d,endAngle:f,color:"#4caf50"}),p.push({startAngle:f,endAngle:u,color:"#f44336"})}else{let o=t/a,f=s/a,x=d+o*c,v=d+f*c;p.push({startAngle:d,endAngle:x,color:"#ffeb3b"}),p.push({startAngle:x,endAngle:v,color:"#4caf50"}),p.push({startAngle:v,endAngle:u,color:"#f44336"})}let L=$(H),A=r-5,C=i.x+A*Math.cos(L),m=i.y+A*Math.sin(L),g="#4caf50";t!==null&&s!==null?e<t?g="#ffeb3b":e>=t&&e<=s?g="#4caf50":g="#f44336":t!==null&&s===null?e<t?g="#ffeb3b":g="#4caf50":t===null&&s!==null&&(e<=s?g="#4caf50":g="#f44336");let w=`
    <svg viewBox="0 0 140 140" style="width: 100%; height: 100%;">
      <!-- Background arc -->
      <path
        d="${b(d,u,r)}"
  ...
  `,D.innerHTML=w}});var Fe=B(()=>{var re=class extends HTMLElement{constructor(){super(),this._eventsAttached=!1,this.maxHeight="400px"}setConfig(e){this.config=e||{},this.profileEntityId=e.profile_entity_id||null,this.title=typeof e.title=="string"?e.title:"Percent of Total Calories",this.maxHeight=e.max_height||"400px",this.innerHTML=`
    ...
    `;let e=this.querySelector("paper-input"),t=this.querySelector("ha-entity-picker"),s=this.querySelectorAll("paper-input")[1],n=this.querySelector(".error"),a=()=>{let i=W({},this._config);e&&e.value?i.title=e.value.trim():delete i.title,t&&t.value?i.profile_entity_id=t.value:delete i.profile_entity_id,s&&s.value?i.max_height=s.value.trim():delete i.max_height,i.profile_entity_id?n&&(n.style.display="none"):n&&(n.style.display="block"),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}}))};e&&e.addEventListener("value-changed",a),t&&t.addEventListener("value-changed",a),s&&s.addEventListener("value-changed",a)}_escape(e){return String(e).replace(/"/g,"&quot;")}};customElements.get("macro-percentages-editor")||customElements.define("macro-percentages-editor",Me);re.getConfigForm=function(){return{schema:[{name:"title",selector:{text:{}}},{name:"profile_entity_id",required:!0,selector:{entity:{domain:"sensor",allow_custom_entity:!0}}},{name:"max_height",selector:{text:{}}}]}};re.getStubConfig=function(){return{profile_entity_id:"",max_height:"400px"}};re.prototype._renderPieChart=function(){let D=this.querySelector(".pie-svg");if(!D)return;let e=this._proteinCals||0,t=this._carbsCals||0,s=this._fatCals||0,n=this._alcoholCals||0,a=this._totalCals||1,i=this._proteinGrams||0,r=this._carbsGrams||0,l=this._fatGrams||0,d=this._alcoholGrams||0,u=a>0?Math.round(e/a*100):0,c=a>0?Math.round(t/a*100):0,F=a>0?Math.round(s/a*100):0,H=a>0?Math.round(n/a*100):0,$=this.querySelector(".protein-text"),b=this.querySelector(".carbs-text"),y=this.querySelector(".fat-text"),M=this.querySelector(".alcohol-text");$&&($.textContent=`Protein: ${i}g (${u}%)`),b&&(b.textContent=`Carbs: ${r}g (${c}%)`),y&&(y.textContent=`Fat: ${l}g (${F}%)`),M&&(M.textContent=`Alcohol: ${d}g (${H}%)`);let k=100,_=100,p=70,L={protein:"#4CAF50",carbs:"#2196F3",fat:"#FF9800",alcohol:"#9C27B0"},A=-90,C=[];if(a>0){if(e>0){let o=e/a*360;C.push({startAngle:A,endAngle:A+o,color:L.protein,label:"Protein"}),A+=o}if(t>0){let o=t/a*360;C.push({startAngle:A,endAngle:A+o,color:L.carbs,label:"Carbs"}),A+=o}if(s>0){let o=s/a*360;C.push({startAngle:A,endAngle:A+o,color:L.fat,label:"Fat"}),A+=o}if(n>0){let o=n/a*360;C.push({startAngle:A,endAngle:A+o,color:L.alcohol,label:"Alcohol"})}}let m=o=>o*Math.PI/180,g=(o,f)=>{let x=m(o),v=m(f),I=k+p*Math.cos(x),P=_+p*Math.sin(x),q=k+p*Math.cos(v),O=_+p*Math.sin(v),G=Math.abs(f-o)>180?1:0;return`M ${k} ${_} L ${I} ${P} A ${p} ${p} 0 ${G} 1 ${q} ${O} Z`},w='<svg viewBox="0 0 200 200" style="width: 100%; height: 100%;">';a===0||C.length===0?w+=`
      <circle cx="${k}" cy="${_}" r="${p}"
    ...
    `,this._syncLastGoalRangeAvailability()}set hass(e){this._hass=e,this._updateCard()}get hass(){return this._hass}async _updateCard(){let e=this.querySelector(".weight-chart");if(!e||!this._hass)return;let t=this.profileEntityId;if(t||(t=Object.keys(this._hass.states).find(s=>s.startsWith("sensor.calorie_tracker_")&&this._hass.states[s])),!t){e.innerHTML="<div>No calorie tracker profile entity found</div>";return}try{let s=this._hass.connection.sendMessagePromise({type:"calorie_tracker/get_weight_history",entity_id:t}),n=this._hass.connection.sendMessagePromise({type:"calorie_tracker/get_goals",entity_id:t}).catch(()=>null),[a,i]=await Promise.all([s,n]);this._weightData=a.weight_history||[],this._lastGoalStartDate=this._extractLastGoalStartDate(i&&Array.isArray(i.goals)?i.goals:null),this._syncLastGoalRangeAvailability(),this._renderChart()}catch(s){this._lastGoalStartDate=null,this._syncLastGoalRangeAvailability(),e.innerHTML="<div>Failed to fetch weight data</div>"}if(!this._eventsAttached){let s=this.querySelector(".weight-range-select");s&&(s.value=this._range,s.addEventListener("change",a=>{if(this._range=a.target.value,this._range==="goal"&&!this._lastGoalStartDate){this._range="1m",s.value=this._range;return}this._renderChart()}));let n=this.querySelector(".weight-chart");n&&window.ResizeObserver&&(this._resizeObserver=new ResizeObserver(()=>{this._renderChart()}),this._resizeObserver.observe(n)),this._eventsAttached=!0}}disconnectedCallback(){this._resizeObserver&&(this._resizeObserver.disconnect(),this._resizeObserver=null)}_filterDataByRange(e,t){if(!e||!Array.isArray(e)||e.length===0)return[];if(t==="all")return e;if(t==="goal"){if(!this._lastGoalStartDate)return[];let a=this._lastGoalStartDate;return e.filter(i=>!i||typeof i.date!="string"?!1:i.date.slice(0,10)>=a)}let s=new Date,n;switch(t){case"2w":n=new Date(s),n.setDate(s.getDate()-13);break;case"1m":n=new Date(s),n.setMonth(s.getMonth()-1);break;case"2m":n=new Date(s),n.setMonth(s.getMonth()-2);break;case"4m":n=new Date(s),n.setMonth(s.getMonth()-4);break;case"6m":n=new Date(s),n.setMonth(s.getMonth()-6);break;case"1y":n=new Date(s),n.setFullYear(s.getFullYear()-1);break;default:return e}return e.filter(a=>new Date(a.date)>=n)}_renderChart(){let e=this.querySelector(".weight-chart"),t=this.querySelector(".legend-items");e&&requestAnimationFrame(()=>{this._doRenderChart(e,t)})}_doRenderChart(e,t){if(!e)return;let s=this._filterDataByRange(this._weightData,this._range);if(!s.length||s.length<2){let h="No weight data available for this range.";this._range==="goal"&&(h=this._lastGoalStartDate?"Need more weight entries since your last goal to display progress.":"Set a goal to track progress from your most recent goal start date."),e.innerHTML=`<div>${h}</div>`,t&&(t.innerHTML="");return}let n=this.profileEntityId||this._hass&&Object.keys(this._hass.states).find(h=>h.startsWith("sensor.calorie_tracker_")),a=null,i=null,r="kg";if(n&&this._hass&&this._hass.states[n]){let h=this._hass.states[n].attributes||{},S=E=>{if(E==null)return null;let T=Number(E);return Number.isFinite(T)?T:null};a=S(h.starting_weight),i=S(h.goal_weight),r=h.weight_unit||"kg"}let l=400,d=260,u=40,c=s.map(h=>new Date(h.date)),F=s.map(h=>h.weight),H=Math.min(...F),$=Math.max(...F),b=c[0],y=c[c.length-1],M=1440*60*1e3,k=Math.max((y-b)/M,1),_=(()=>{if(c.length<2)return null;let h=c.map(j=>(j.getTime()-b.getTime())/M),S=F,E=h.length,T=0,N=0,K=0,U=0;for(let j=0;j<E;j++){let Z=h[j],le=S[j];T+=Z,N+=le,K+=Z*le,U+=Z*Z}let ee=E*U-T*T;if(Math.abs(ee)<1e-9)return null;let J=(E*K-T*N)/ee,oe=(N-J*T)/E,ge=N/E,Q=0,te=0;for(let j=0;j<E;j++){let Z=oe+J*h[j],le=S[j];Q+=(le-ge)**2,te+=(le-Z)**2}let fe=Q>0?1-te/Q:1;return{slope:J,intercept:oe,weightAt:j=>{let Z=(j.getTime()-b.getTime())/M;return oe+J*Z},rSquared:fe}})(),p=0,L=y,A=null,C=!1;if(_){let h=_.slope,S=k,E=_.weightAt(y),T=S;if(i!==null&&Math.abs(h)>1e-6){let N=(i-E)/h;N>=0&&(C=!0,A=N,T=Math.min(T,N))}Math.abs(h)>1e-6&&(p=Math.max(0,T),p>0&&(L=new Date(y.getTime()+p*M)))}let m=p>0?L:y,g=b.getTime(),w=m.getTime(),o=h=>u+(h.getTime()-g)/Math.max(w-g,1)*(l-2*u),f=H,x=$;if(i!==null&&(f=Math.min(f,i),x=Math.max(x,i)),_&&p>0){let h=_.weightAt(L);f=Math.min(f,h),x=Math.max(x,h)}let v=x-f||1,I=.15,P=f-v*I,q=x+v*I,O=a!==null&&a>=P&&a<=q,G=i!==null&&i>=P&&i<=q;if(t){let h="";if(a!==null){let S=O?"":a>q?" \u2191":" \u2193";h+=`<div style="display:flex;align-items:center;"><div style="width:12px;height:2px;background:#ff9800;margin-right:4px;border-style:dashed;border-width:1px 0;border-color:#ff9800;"></div><span style="font-size:12px;">Start: ${a}${S}</span></div>`}if(i!==null){let S=G?"":i>q?" \u2191":" \u2193";h+=`<div style="display:flex;align-items:center;"><div style="width:12px;height:2px;background:#8bc34a;margin-right:4px;border-style:dashed;border-width:1px 0;border-color:#8bc34a;"></div><span style="font-size:12px;">Goal: ${i}${S}</span></div>`}t.innerHTML=h}let z=this.querySelector(".weight-prediction");if(z)if(!_)z.style.display="none";else{let h=_.slope*7,S=h>=0?`+${h.toFixed(2)}`:h.toFixed(2),E=_.rSquared>.8?"high":_.rSquared>.5?"medium":"low",N=`<strong>Trend:</strong> ${S} ${r}/week <span style="color:${E==="high"?"var(--success-color, #4caf50)":E==="medium"?"var(--warning-color, #ff9800)":"var(--error-color, #f44336)"};font-weight:bold;">(${E} confidence)</span>`;if(i===null)N+="<br/><em>Set a goal weight to see a predicted goal date.</em>";else if(Math.abs(_.slope)<1e-6)N+="<br/><em>Trend is flat, unable to project goal date.</em>";else if(!C)N+="<br/><em>Trend is moving away from the goal weight.</em>";else if(A!==null&&Number.isFinite(A)){let K=new Date(y.getTime()+A*M),ee=Math.round((K-new Date)/M),J=K.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"});N+=`<br/><strong>Goal projection:</strong> ${J} (${ee} days)`}else N+="<br/><em>Unable to calculate goal projection.</em>";z.innerHTML=N,z.style.display="block"}let Y=h=>d-u-(h-P)/(q-P)*(d-2*u),X=s.map(h=>[o(new Date(h.date)),Y(h.weight)]),R=`<svg viewBox='0 0 ${l} ${d}' preserveAspectRatio='xMidYMid meet' style='width:100%;height:auto;'>`,Ce=h=>{let S=h.getDate().toString().padStart(2,"0"),T=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][h.getMonth()];return`${S} ${T}`};for(let h=0;h<5;h++){let S=h/4,E=g+S*(w-g),T=new Date(E),N=o(T);R+=`<line x1='${N}' y1='${u}' x2='${N}' y2='${d-u}' stroke='#d0d0d0' stroke-width='0.5' stroke-dasharray='3,3' />`,R+=`<text x='${N}' y='${d-u+18}' font-size='11' fill='#888' text-anchor='middle'>${Ce(T)}</text>`}for(let h=0;h<5;h++){let S=h/4,E=P+S*(q-P),T=Y(E);R+=`<line x1='${u}' y1='${T}' x2='${l-u}' y2='${T}' stroke='#d0d0d0' stroke-width='0.5' stroke-dasharray='3,3' />`,R+=`<text x='${u-12}' y='${T+4}' font-size='11' fill='#888' text-anchor='end'>${E.toFixed(1)}</text>`}if(R+=`<polyline fill='none' stroke='#03a9f4' stroke-width='2' points='${X.map(h=>h.join(",")).join(" ")}' />`,_){let h=b,S=y,E=o(h),T=Y(_.weightAt(h)),N=o(S),K=Y(_.weightAt(S));if(R+=`<line x1='${E}' y1='${T}' x2='${N}' y2='${K}' stroke='#9c27b0' stroke-width='2' opacity='0.9' />`,p>0){let U=y,ee=_.weightAt(U),J=_.weightAt(L),oe=o(U),ge=Y(ee),Q=o(L),te=Y(J);R+=`<line x1='${oe}' y1='${ge}' x2='${Q}' y2='${te}' stroke='#9c27b0' stroke-width='1.75' stroke-dasharray='8,6' opacity='0.6' />`,R+=`<circle cx='${Q}' cy='${te}' r='3.5' fill='#9c27b0' opacity='0.6' />`;let fe=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],ye=L,j=`${ye.getDate()} ${fe[ye.getMonth()]}`;R+=`<text x='${Q}' y='${te-12}' font-size='10' fill='#9c27b0' text-anchor='middle' opacity='0.7'>${j}</text>`}}if(X.forEach((h,S)=>{R+=`<circle class='weight-point' data-index='${S}' cx='${h[0]}' cy='${h[1]}' r='4' fill='#03a9f4' stroke='#fff' stroke-width='1.5' style='cursor:pointer;' />`}),O){let h=Y(a);R+=`<line x1='${u}' y1='${h}' x2='${l-u}' y2='${h}' stroke='#ff9800' stroke-dasharray='4,2' stroke-width='1.5' />`}if(G){let h=Y(i);R+=`<line x1='${u}' y1='${h}' x2='${l-u}' y2='${h}' stroke='#8bc34a' stroke-dasharray='4,2' stroke-width='1.5' />`}if(a!==null&&!O){let h=a>q,S=h?u+5:d-u-5,E=h?"\u2191":"\u2193";R+=`<text x='${l-u-40}' y='${S}' font-size='12' fill='#ff9800' text-anchor='start'>Start ${E}</text>`}if(i!==null&&!G){let h=i>q,S=h?u+5:d-u-5,E=h?"\u2191":"\u2193",T=a!==null&&!O&&i>q==a>q?80:40;R+=`<text x='${l-u-T}' y='${S}' font-size='12' fill='#8bc34a' text-anchor='start'>Goal ${E}</text>`}R+="</svg>",e.innerHTML=`<div style="position:relative;width:100%;">${R}<div class="weight-tooltip" style="position:absolute;display:none;background:rgba(0,0,0,0.8);color:white;padding:8px 12px;border-radius:4px;font-size:12px;pointer-events:none;z-index:1000;white-space:nowrap;"></div></div>`;let ne=e.querySelector(".weight-tooltip");e.querySelectorAll(".weight-point").forEach(h=>{h.addEventListener("mouseenter",S=>{let E=parseInt(S.target.getAttribute("data-index")),T=s[E],N=new Date(T.date);ne.innerHTML=`<div><strong>${Ce(N)}</strong></div><div>${T.weight} ${r}</div>`,ne.style.display="block"}),h.addEventListener("mousemove",S=>{let E=e.getBoundingClientRect();ne.style.left=S.clientX-E.left+10+"px",ne.style.top=S.clientY-E.top-10+"px"}),h.addEventListener("mouseleave",()=>{ne.style.display="none"})})}_extractLastGoalStartDate(e){if(!Array.isArray(e)||e.length===0)return null;let t=e.map(s=>{if(!s||typeof s.start_date!="string")return null;let n=s.start_date.trim();return n?n.slice(0,10):null}).filter(Boolean);return t.length?t.reduce((s,n)=>s&&s>n?s:n,null):null}_syncLastGoalRangeAvailability(){let e=this.querySelector(".weight-range-select");if(!e)return;let t=[...e.options].find(n=>n.value==="goal");if(!t)return;let s=!!this._lastGoalStartDate;if(t.disabled=!s,t.hidden=!s,s){let n=new Date(this._lastGoalStartDate);if(Number.isNaN(n.getTime()))t.textContent="Since last goal";else{let a=n.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"});t.textContent=`Since last goal (${a})`}}else t.textContent="Since last goal",this._range==="goal"&&(this._range="1m",e.value=this._range)}};customElements.get("weight-progress-card")||customElements.define("weight-progress-card",pe);window.customCards=window.customCards||[];window.customCards.push({type:"weight-progress-card",name:"Calorie Tracker: Weight Progress",description:"Displays weight history and progress for Calorie Tracker",editor:"weight-progress-editor",preview:!0});var ke=class extends HTMLElement{setConfig(e){this._config=e||{},this._render()}set hass(e){this._hass=e,this._render()}_render(){this._config||(this._config={});let e=[["2w","Last 2 weeks"],["1m","Last month"],["2m","Last 2 months"],["4m","Last 4 months"],["6m","Last 6 months"],["1y","Last year"],["goal","Since last goal"],["all","All"]],t=this._config.default_range||"1m";this.innerHTML=`
      <div style="display:flex;flex-direction:column;gap:8px;">
        <paper-input label="Title (optional)" value="${this._escape(this._config.title||"")}"></paper-input>
        <label style="font-size:12px;color:var(--secondary-text-color);">Profile entity (required)</label>
        <ha-entity-picker dialog-opp="right" include-domains="sensor" allow-custom-entity value="${this._escape(this._config.profile_entity_id||"")}"></ha-entity-picker>
    ...
    `;let s=this.querySelector("paper-input"),n=this.querySelector("ha-entity-picker"),a=this.querySelector("select"),i=this.querySelector(".error"),r=()=>{let l=W({},this._config);s&&s.value?l.title=s.value.trim():delete l.title,n&&n.value?l.profile_entity_id=n.value:delete l.profile_entity_id,a&&a.value?l.default_range=a.value:delete l.default_range,l.profile_entity_id?i&&(i.style.display="none"):i&&(i.style.display="block"),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:l}}))};s&&s.addEventListener("value-changed",r),n&&n.addEventListener("value-changed",r),a&&a.addEventListener("change",r)}_escape(e){return String(e).replace(/"/g,"&quot;")}};customElements.get("weight-progress-editor")||customElements.define("weight-progress-editor",ke);pe.getConfigForm=function(){return{schema:[{name:"title",selector:{text:{}}},{name:"profile_entity_id",required:!0,selector:{entity:{domain:"sensor",allow_custom_entity:!0}}},{name:"default_range",selector:{select:{options:[{value:"2w",label:"Last 2 weeks"},{value:"1m",label:"Last month"},{value:"2m",label:"Last 2 months"},{value:"4m",label:"Last 4 months"},{value:"6m",label:"Last 6 months"},{value:"1y",label:"Last year"},{value:"goal",label:"Since last goal"},{value:"all",label:"All"}]}}}]}};pe.getStubConfig=function(){return{profile_entity_id:"",default_range:"1m"}}});var Pe=B(()=>{var ht=V(Se()),ut=V(Ee()),pt=V(Le()),gt=V(Ae()),ft=V(De()),yt=V(Te()),mt=V(qe()),_t=V(Fe()),xt=V(He())});export default Pe();
